    ...
    <div class="container">
        ...
        <section class="row">
            <div id="show-sample" class="col-12 content scaffold-show" role="main">
                ...
                <f:display bean="sample" order="dateCreated,name" listClass="container" listItemClass="row mb-3" labelClass="form-label col-sm-3 text-sm-end" valueClass="col-sm-9" />
